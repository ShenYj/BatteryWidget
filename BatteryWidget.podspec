#
#  Be sure to run `pod spec lint BatteryWidget.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "BatteryWidget"
  spec.version      = "0.0.1"
  spec.summary      = "A basic Widget of Battery."
  ...
  spec.source       = { :git => "https://github.com/ShenYj/BatteryWidget.git", :tag => "#{spec.version}" }
